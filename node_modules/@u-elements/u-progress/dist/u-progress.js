...
var UHTMLProgressShadowRoot = declarativeShadowRoot(UHTMLProgressStyle);
...
var UHTMLProgressElement = class extends UHTMLElement {
  ...
  attributeChangedCallback() {
    ...
    if (IS_IOS) label = `${label.replace(/\d+%$/, "")} ${percentage}%`;
...
export { UHTMLProgressElement, UHTMLProgressShadowRoot, UHTMLProgressStyle };
